...
#         await ctx.send(embed=embed) 
    ...
    async def partida(self, ctx, player_one, player_two, time):
        ...
        embed.set_thumbnail(url="https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fliquipedia.net%2Fcommons%2Fimages%2Fthumb%2Fe%2Fe1%2FRocket_League.png%2F600px-Rocket_League.png&f=1&nofb=1")
        games_channel = ctx.guild.get_channel(762774198031482930)
